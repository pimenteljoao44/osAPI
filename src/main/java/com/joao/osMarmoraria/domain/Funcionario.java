...
public class Funcionario implements Serializable {
    ...
    public Funcionario(Integer id, String cargo, BigDecimal salario, String ctps, Pessoa pessoa, List<OrdemServico> listOs, Date dataCriacao, Date dataAtualizacao) {
        this.id = id;
        this.cargo = cargo;
