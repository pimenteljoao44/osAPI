...
public class AuthController {
    ...
    public ResponseEntity recovery(@RequestBody @Valid RecoveryDTO data) {
        ...
        if (usuario != null) {
            ...
            usuarioService.update(new UsuarioDTO(usuario.getId(),usuario.getNome(),usuario.getLogin(),senhaTemp,usuario.getEmail(),usuario.getNivelAcesso().getCod(),usuario.getFuncionario()));
